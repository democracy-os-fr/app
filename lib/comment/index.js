...
var verified_citizen = require('lib/netid-middlewares').verified_citizen;
...
app.post('/comment/:id/upvote', restrict, verified_citizen, function(req, res) {
...
app.post('/comment/:id/downvote', restrict, verified_citizen, function(req, res) {
  log('Request /comment/%s/upvote', req.params.id);
...
app.post('/comment/:id/flag', restrict, verified_citizen, function(req, res) {
...
app.put('/comment/:commentId/reply/:replyId', function (req, res) {
  ...
  api.comment.getFor( { _id: req.params.commentId }, function (err, comments) {
    if (err) return _handleError(err, req, res);
