...
app.get('/comment/all', function (req, res) {
  if (!req.query.topicId) {
    return _handleError(new Error('Request didn\'t include `topicId` parameter'), req, res);
  }
  ...
  var userId = req.query.excludeUser ? {'$ne': req.query.excludeUser} : null;
...
app.get('/comment/mine', restrict, function (req, res) {
  if (!req.query.topicId) {
    return _handleError(new Error('Request didn\'t include `id` parameter'), req, res);
  }
...
app.post('/comment', restrict, function (req, res) {
  if (!req.query.topicId) {
    return _handleError(new Error('Request didn\'t include `id` parameter'), req, res);
  }
