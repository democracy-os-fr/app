...
module.exports = {
  ...
  client: env.CLIENT_CONF ? env.CLIENT_CONF.split(',') : [ "protocol", "host", "publicPort", "env", "locale", "logo", "favicon", "organization name", "organization url", "learn more url", "google analytics tracking id", "netid enabled", "netid instructions url", "comments per page" ],
  auth: {
    basic: {
  ...
  "comments per page": env.COMMENTS_PER_PAGE || 0
};