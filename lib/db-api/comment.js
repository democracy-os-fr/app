...
exports.getFor = function getFor(query, paging, fn) {
  ...
  .exec(function(err, comments) {
    ...
    var opts = { path: 'author', select: 'id firstName lastName fullName email avatar country' };
...
exports.replies = function replies(id, fn) {
  ...
  .exec(function(err, comment) {
    ...
    var opts = { path: 'replies.author', select: 'id firstName lastName fullName email avatar country' };
...
exports.reply = function reply(commentId, reply, fn) {
  ...
  Comment.findById(commentId, function(err, comment) {
    ...
    comment.save(function(err, saved) {
      ...
      var opts = { path: 'replies.author', select: 'id firstName lastName fullName email profilePictureUrl country' };
